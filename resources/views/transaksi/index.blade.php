...
<x-master-layout :title="$title">
    <div class="w-full bg-white rounded-xl shadow-sm p-3 mb-4">
        <form id="filterTanggalForm" action="{{ route('transaksi') }}" method="GET">
            <div id="date-range-picker" date-rangepicker class="flex flex-col md:flex-row items-center gap-4">
                ...
                <span class="hidden md:block text-gray-500">ke</span>
                <div class="relative w-full md:w-auto">
                    <div class="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
                        <svg class="w-4 h-4 text-gray-500 dark:text-gray-400" aria-hidden="true"
                            xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                ...
                <button type="submit"
                    class="w-full md:w-auto text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Filter</button>
            </div>
        </form>
    </div>
