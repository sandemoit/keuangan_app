...
<x-master-layout :title="$title">
    <div class="w-full bg-white rounded-xl shadow-sm p-3 mb-4">
        <form id="filterTanggalForm" action="{{ route('keuangan.keluar') }}" method="GET">
    ...
    @push('custom-js')
        ...
        <script>
            if (document.getElementById("keuanganKeluar") && typeof simpleDatatables.DataTable !== 'undefined') {
                const dataTable = new simpleDatatables.DataTable("#keuanganKeluar", {
                    searchable: true,
                    paging: true,
                    perPage: 10,
